...
## Demo Video
 ...
 [![Watch the Open3D scramble and solve demo](pics/rubik_cube.png)](vids/3D_Scramble_and_Solve.mov)

 video : [vids/3D_Scramble_and_Solve.mov](vids/3D_Scramble_and_Solve.mov)
